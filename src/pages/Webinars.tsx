...
export default function Webinars() {
  ...
  // Logic of fetching webinars from backend
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 dark:from-slate-950 dark:via-blue-950/30 dark:to-indigo-950">
      ...
      <div className="relative container mx-auto px-4 py-16 md:py-24">
        ...
        {isLoading && (
          <div className="text-center text-xl text-slate-600 dark:text-slate-300">
            Loading webinars...
          </div>
        )}
        ...
        {!isLoading && !error && filteredWebinars.length === 0 && (
          <div className="text-center text-xl text-slate-600 dark:text-slate-300">
            No webinars found for the selected criteria.
          </div>
        )}
